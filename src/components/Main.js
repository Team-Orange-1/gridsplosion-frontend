...
class Main extends React.Component {
  ...
  moveRight() {
    ...
    if (this.state.playerCoordinate[0] < 22 && this.checkBlock2(newCoordinate[0], newCoordinate[1])) {
  ...
  moveLeft() {
    let newCoordinate = [this.state.playerCoordinate[0] - 2, this.state.playerCoordinate[1]];
    if (this.state.playerCoordinate[0] > 0 && this.checkBlock2(newCoordinate[0], newCoordinate[1])) {
      this.setState({ playerCoordinate: newCoordinate });
    }
  }
  ...
  moveUp() {
    ...
    if (this.state.playerCoordinate[1] > .1 && this.checkBlock2(newCoordinate[0], newCoordinate[1])) {
      this.setState({ playerCoordinate: newCoordinate });
    }
  }
  ...
  moveDown() {
    let newCoordinate = [this.state.playerCoordinate[0], this.state.playerCoordinate[1] + 2];
    if (this.state.playerCoordinate[1] < 22 && this.checkBlock2(newCoordinate[0], newCoordinate[1])) {
      this.setState({ playerCoordinate: newCoordinate });
    }
  }
